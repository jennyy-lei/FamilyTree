...
// import {PersonRepository} from './person_repository';
//
...
// let pair: number[] = [];
//
// graphRenderer.onNodeClick(function (nodeData: Person, nodeElement: any) {
...
// // }
//
// function addRelationFromDropdown(leftId: number, rightId: number, type: String) {
//   switch (type) {
//     case 'parent':
//       addRelation({
//         leftId: rightId,
...
//   const person: Person = personRepository.getPerson(leftId);
